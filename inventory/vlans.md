...
| `30` | Server | `192.168.30.0/24` | HAOS and Docker VM workloads | ✅ live; dedicated Server zone + Phase 2B DNS-bypass blocks applied 2026-05-04 |
...
| DNS | `192.168.1.55` |
| Firewall zone | `Server` `69f7de611bc6e72d2776b75b` — moved from `Internal` in Phase 2A; Phase 2B DNS-bypass blocks applied 2026-05-04. Isolation plan: [`docs/opti/server-vlan30-isolation-plan-2026-05-03.md`](../docs/opti/server-vlan30-isolation-plan-2026-05-03.md) |
