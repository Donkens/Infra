...
| Server | LIVE | `30` | `192.168.30.0/24` | `192.168.30.1` | `192.168.30.100`-`192.168.30.199` | `192.168.1.55` | none | none | none | `home.lan` | Server `69f7de611bc6e72d2776b75b` | `69ee65711bc6e72d27744844` | Dedicated firewall zone created 2026-05-04 Phase 2A. Phase 2B isolation/block rules still pending. |
...
- Server VLAN 30 exists live in the dedicated `Server` firewall zone. Workload readiness still depends on Phase 2B firewall/isolation validation.
