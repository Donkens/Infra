...
| Host | Role | Notes |
| --- | --- | --- |
| Raspberry Pi | DNS primary | AdGuard Home -> Unbound, `192.168.1.55`. SDRAM baseline: `sdram_freq=550`, documented in [Raspberry Pi 3B+ SDRAM OC baseline](../docs/raspberry-pi-3b-plus-sdram-oc-baseline-2026-04-27.md). |
